...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_GLWidget3D_t, stringdata) + ofs \
...
const QMetaObject GLWidget3D::staticMetaObject = {
    { &GLWidget::staticMetaObject, qt_meta_stringdata_GLWidget3D.data,
      qt_meta_data_GLWidget3D,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GLWidget3D.stringdata))
